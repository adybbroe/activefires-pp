...
def test_prepare_posttroll_message(setup_comm, gethostname, fake_yamlconfig_file_post_processing):
...
def test_create_output_message(tmp_path):
    ...
    geojson_alarm = {"features": {"geometry": {"coordinates": [16.249069, 57.156235], "type": "Point"},
                                  "properties": {"confidence": 8, "observation_time": "2021-06-19T02:58:45.700000+02:00",  # noqa
